...
read_csv_cols_from_bucket <- function(directory = 'data/', my_bucket = 'gs://allxall-phenotypes'
                                      , name_of_file_in_bucket, concept_id, remove_dot = 'no'){
...
read_csv_from_bucket <- function(my_bucket = 'gs://allxall-phenotypes', directory = 'data/'
                                 , name_of_file_in_bucket, remove_dot = 'no'){
